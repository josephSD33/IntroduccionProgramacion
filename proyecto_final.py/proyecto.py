...
def menuinicio():
    ...
    tt.Label(ventana, text="Menu principal",font=("Helvetica", 12),bg="cyan").pack()
    tt.Label(ventana, bg="cyan").pack()
...
def crear():
    ...
    ventanacrear.config(background="cyan")
    tt.Label(ventanacrear,text="Crear un nuevo usuario",font=("Helvetica", 11),bg="cyan").pack()
    tt.Label(ventanacrear,bg= "cyan").pack()
    tt.Label(ventanacrear, text="Nombre del usuario",font=("Helvetica", 9),fg="black",bg="cyan").pack()
    tt.Entry(ventanacrear, textvariable=crearusuario).pack()
    tt.Label(ventanacrear, text="Contraseña",font=("Helvetica",9),fg="black",bg="cyan").pack()
...
def ingreso():
    ...
    ventanamenu.geometry("350x315")
    ventanamenu.config(background="cyan")
    tt.Label(ventanamenu, text="Menu de Usuario",font=("Helvetica", 13),bg="cyan",width="100").pack()
    tt.Label(ventanamenu,bg="cyan").pack()
...
def vercontactos():
    ...
    if usuario in agendausuario and agendausuario[usuario]["contactos"]:
        ...
        ventanavc.config(background="cyan")
        ...
        for nombre, info in lista_contactos.items():
            tt.Label(ventanavc, text=f"Nombre: {nombre}",bg="cyan").pack()
            tt.Label(ventanavc, text=f"Número: {info['numero']}",bg="cyan").pack()
            tt.Label(ventanavc, text=f"Correo: {info['correo']}",bg="cyan").pack()
...
def vertareas():
    ...
    if usuario in agendausuario and agendausuario[usuario]["tareas"]:
        ...
        ventanavt.config(background="cyan")
...
def eventos():
    ...
    if usuario in agendausuario and agendausuario[usuario]["eventos"]:
        ...
        ventanaev.config(background="cyan")
...
def agregrarevento():
    ...
    if usuario in agendausuario:
        ...
        ventanae.config(background="cyan")
        ...
        tt.Label(ventanae, text="Descripción",bg="cyan").pack()
        tt.Entry(ventanae, textvariable=nuevoevento).pack()

        tt.Label(ventanae, text="Fecha (dia/mes/año)",bg="cyan").pack()
